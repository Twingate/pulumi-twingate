...
func Provider() bridgev3.ProviderInfo {
	...
	prov := bridgev3.ProviderInfo{
		...
		Resources: map[string]*bridgev3.ResourceInfo{
			...
			"twingate_ssh_certificate_authority": {
				Tok: bridgev3.MakeResource(mainPkg, mainMod, "TwingateSSHCertificateAuthority"),
			},
		...
		DataSources: map[string]*bridgev3.DataSourceInfo{
			...
			"twingate_gateway":         {Tok: bridgev3.MakeDataSource(mainPkg, mainMod, "getTwingateGateway")},
			...
			"twingate_dns_filtering_profile": {
				Tok: bridgev3.MakeDataSource(mainPkg, mainMod, "getTwingateDNSFilteringProfile"),
			},
			"twingate_security_policies": {
				Tok: bridgev3.MakeDataSource(mainPkg, mainMod, "getTwingateSecurityPolicies"),
			},
			"twingate_service_accounts": {
				Tok: bridgev3.MakeDataSource(mainPkg, mainMod, "getTwingateServiceAccounts"),
			},
			"twingate_ssh_certificate_authority": {
				Tok: bridgev3.MakeDataSource(mainPkg, mainMod, "getTwingateSSHCertificateAuthority"),
			},
			"twingate_x509_certificate_authority": {
