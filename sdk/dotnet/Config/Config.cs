...
namespace Twingate.Twingate
{
    public static class Config
    {
        ...
        private static readonly __Value<Twingate.Config.Types.Cache?> _cache = new __Value<Twingate.Config.Types.Cache?>(() => __config.GetObject<Twingate.Config.Types.Cache>("cache"));
        /// <summary>
        /// Specifies the cache settings for the provider.
        /// </summary>
        public static Twingate.Config.Types.Cache? Cache
        {
            get => _cache.Get();
            set => _cache.Set(value);
        }

        private static readonly __Value<Twingate.Config.Types.DefaultTags?> _defaultTags = new __Value<Twingate.Config.Types.DefaultTags?>(() => __config.GetObject<Twingate.Config.Types.DefaultTags>("defaultTags"));
        /// <summary>
        /// A default set of tags applied globally to all resources created by the provider.
        /// </summary>
        public static Twingate.Config.Types.DefaultTags? DefaultTags
        {
