...
namespace Twingate.Twingate.Outputs
{
    ...
    [OutputType]
    public sealed class TwingateSSHResourceAccessGroup
    {
        /// <summary>
        /// Restrict access according to JIT access policy
        /// </summary>
        public readonly ImmutableArray<Outputs.TwingateSSHResourceAccessGroupAccessPolicy> AccessPolicies;
        /// <summary>
        ...
        [OutputConstructor]
        private TwingateSSHResourceAccessGroup(
            ImmutableArray<Outputs.TwingateSSHResourceAccessGroupAccessPolicy> accessPolicies,
