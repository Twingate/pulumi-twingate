...
namespace Twingate.Twingate.Outputs
{
    ...
    [OutputType]
    public sealed class TwingateWebAppResourceAccessGroup
    {
        /// <summary>
        /// Restrict access according to JIT access policy
        /// </summary>
        public readonly ImmutableArray<Outputs.TwingateWebAppResourceAccessGroupAccessPolicy> AccessPolicies;
        /// <summary>
        ...
        [OutputConstructor]
        private TwingateWebAppResourceAccessGroup(
            ImmutableArray<Outputs.TwingateWebAppResourceAccessGroupAccessPolicy> accessPolicies,
