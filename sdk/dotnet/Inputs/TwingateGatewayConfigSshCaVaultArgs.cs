...
namespace Twingate.Twingate.Inputs
{
    ...
    public sealed class TwingateGatewayConfigSshCaVaultArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("auth")]
        public Input<Inputs.TwingateGatewayConfigSshCaVaultAuthArgs>? Auth { get; set; }
        ...
        public TwingateGatewayConfigSshCaVaultArgs()
        {
        }
        public static new TwingateGatewayConfigSshCaVaultArgs Empty => new TwingateGatewayConfigSshCaVaultArgs();
    }
}
