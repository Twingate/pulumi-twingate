...
namespace Twingate.Twingate.Inputs
{
    ...
    public sealed class TwingateSSHResourceAccessPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public TwingateSSHResourceAccessPolicyArgs()
        {
        }
        public static new TwingateSSHResourceAccessPolicyArgs Empty => new TwingateSSHResourceAccessPolicyArgs();
    }
}
