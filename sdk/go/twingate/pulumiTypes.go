...
// Returns only resources that are associated with the specified remote network ID.
func (o ProviderCacheResourcesFilterOutput) RemoteNetworkId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProviderCacheResourcesFilter) *string { return v.RemoteNetworkId }).(pulumi.StringPtrOutput)
}

// Returns only resources that are associated with the specified remote network name.
func (o ProviderCacheResourcesFilterOutput) RemoteNetworkName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ProviderCacheResourcesFilter) *string { return v.RemoteNetworkName }).(pulumi.StringPtrOutput)
}
...
// Returns only resources that are associated with the specified remote network ID.
func (o ProviderCacheResourcesFilterPtrOutput) RemoteNetworkId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProviderCacheResourcesFilter) *string {
		if v == nil {
			return nil
		}
...
// Returns only resources that are associated with the specified remote network name.
func (o ProviderCacheResourcesFilterPtrOutput) RemoteNetworkName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProviderCacheResourcesFilter) *string {
		if v == nil {
			return nil
		}
...
type TwingateWebAppResourceAccessGroup struct {
	// Restrict access according to JIT access policy
	AccessPolicies []TwingateWebAppResourceAccessGroupAccessPolicy `pulumi:"accessPolicies"`
	// Group ID that will have permission to access the Resource.
	GroupId *string `pulumi:"groupId"`
	// The ID of a `getTwingateSecurityPolicy` to use as the access policy for the group IDs in the access block. Default is 'Null' which points to `Default Policy` on Admin console.
	SecurityPolicyId *string `pulumi:"securityPolicyId"`
...
// TwingateWebAppResourceAccessGroupInput is an input type that accepts TwingateWebAppResourceAccessGroupArgs and TwingateWebAppResourceAccessGroupOutput values.
// You can construct a concrete instance of `TwingateWebAppResourceAccessGroupInput` via:
//
//	TwingateWebAppResourceAccessGroupArgs{...}
type TwingateWebAppResourceAccessGroupInput interface {
	pulumi.Input

	ToTwingateWebAppResourceAccessGroupOutput() TwingateWebAppResourceAccessGroupOutput
	ToTwingateWebAppResourceAccessGroupOutputWithContext(context.Context) TwingateWebAppResourceAccessGroupOutput
}

type TwingateWebAppResourceAccessGroupArgs struct {
	// Restrict access according to JIT access policy
	AccessPolicies TwingateWebAppResourceAccessGroupAccessPolicyArrayInput `pulumi:"accessPolicies"`
	// Group ID that will have permission to access the Resource.
	GroupId pulumi.StringPtrInput `pulumi:"groupId"`
	// The ID of a `getTwingateSecurityPolicy` to use as the access policy for the group IDs in the access block. Default is 'Null' which points to `Default Policy` on Admin console.
	SecurityPolicyId pulumi.StringPtrInput `pulumi:"securityPolicyId"`
...
func (TwingateWebAppResourceAccessGroupArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*TwingateWebAppResourceAccessGroup)(nil)).Elem()
}

func (i TwingateWebAppResourceAccessGroupArgs) ToTwingateWebAppResourceAccessGroupOutput() TwingateWebAppResourceAccessGroupOutput {
	return i.ToTwingateWebAppResourceAccessGroupOutputWithContext(context.Background())
}

func (i TwingateWebAppResourceAccessGroupArgs) ToTwingateWebAppResourceAccessGroupOutputWithContext(ctx context.Context) TwingateWebAppResourceAccessGroupOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TwingateWebAppResourceAccessGroupOutput)
}

// TwingateWebAppResourceAccessGroupArrayInput is an input type that accepts TwingateWebAppResourceAccessGroupArray and TwingateWebAppResourceAccessGroupArrayOutput values.
// You can construct a concrete instance of `TwingateWebAppResourceAccessGroupArrayInput` via:
//
//	TwingateWebAppResourceAccessGroupArray{ TwingateWebAppResourceAccessGroupArgs{...} }
type TwingateWebAppResourceAccessGroupArrayInput interface {
	pulumi.Input

	ToTwingateWebAppResourceAccessGroupArrayOutput() TwingateWebAppResourceAccessGroupArrayOutput
	ToTwingateWebAppResourceAccessGroupArrayOutputWithContext(context.Context) TwingateWebAppResourceAccessGroupArrayOutput
}

type TwingateWebAppResourceAccessGroupArray []TwingateWebAppResourceAccessGroupInput

func (TwingateWebAppResourceAccessGroupArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]TwingateWebAppResourceAccessGroup)(nil)).Elem()
}

func (i TwingateWebAppResourceAccessGroupArray) ToTwingateWebAppResourceAccessGroupArrayOutput() TwingateWebAppResourceAccessGroupArrayOutput {
	return i.ToTwingateWebAppResourceAccessGroupArrayOutputWithContext(context.Background())
}

func (i TwingateWebAppResourceAccessGroupArray) ToTwingateWebAppResourceAccessGroupArrayOutputWithContext(ctx context.Context) TwingateWebAppResourceAccessGroupArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TwingateWebAppResourceAccessGroupArrayOutput)
}

type TwingateWebAppResourceAccessGroupOutput struct{ *pulumi.OutputState }

func (TwingateWebAppResourceAccessGroupOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*TwingateWebAppResourceAccessGroup)(nil)).Elem()
}

func (o TwingateWebAppResourceAccessGroupOutput) ToTwingateWebAppResourceAccessGroupOutput() TwingateWebAppResourceAccessGroupOutput {
	return o
}

func (o TwingateWebAppResourceAccessGroupOutput) ToTwingateWebAppResourceAccessGroupOutputWithContext(ctx context.Context) TwingateWebAppResourceAccessGroupOutput {
	return o
}

// Restrict access according to JIT access policy
func (o TwingateWebAppResourceAccessGroupOutput) AccessPolicies() TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput {
	return o.ApplyT(func(v TwingateWebAppResourceAccessGroup) []TwingateWebAppResourceAccessGroupAccessPolicy {
		return v.AccessPolicies
	}).(TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput)
}

// Group ID that will have permission to access the Resource.
func (o TwingateWebAppResourceAccessGroupOutput) GroupId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v TwingateWebAppResourceAccessGroup) *string { return v.GroupId }).(pulumi.StringPtrOutput)
}

// The ID of a `getTwingateSecurityPolicy` to use as the access policy for the group IDs in the access block. Default is 'Null' which points to `Default Policy` on Admin console.
func (o TwingateWebAppResourceAccessGroupOutput) SecurityPolicyId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v TwingateWebAppResourceAccessGroup) *string { return v.SecurityPolicyId }).(pulumi.StringPtrOutput)
}

type TwingateWebAppResourceAccessGroupArrayOutput struct{ *pulumi.OutputState }

func (TwingateWebAppResourceAccessGroupArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]TwingateWebAppResourceAccessGroup)(nil)).Elem()
}

func (o TwingateWebAppResourceAccessGroupArrayOutput) ToTwingateWebAppResourceAccessGroupArrayOutput() TwingateWebAppResourceAccessGroupArrayOutput {
	return o
}

func (o TwingateWebAppResourceAccessGroupArrayOutput) ToTwingateWebAppResourceAccessGroupArrayOutputWithContext(ctx context.Context) TwingateWebAppResourceAccessGroupArrayOutput {
	return o
}

func (o TwingateWebAppResourceAccessGroupArrayOutput) Index(i pulumi.IntInput) TwingateWebAppResourceAccessGroupOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) TwingateWebAppResourceAccessGroup {
		return vs[0].([]TwingateWebAppResourceAccessGroup)[vs[1].(int)]
	}).(TwingateWebAppResourceAccessGroupOutput)
}

type TwingateWebAppResourceAccessGroupAccessPolicy struct {
	// This will set the approval model for the policy. The valid values are `AUTOMATIC` and `MANUAL`.
	ApprovalMode *string `pulumi:"approvalMode"`
	// This will set the access duration for the policy. Duration must be between 1 hour and 365 days. Examples of valid values include `1h` and `2d`.
	Duration *string `pulumi:"duration"`
...
// TwingateWebAppResourceAccessGroupAccessPolicyInput is an input type that accepts TwingateWebAppResourceAccessGroupAccessPolicyArgs and TwingateWebAppResourceAccessGroupAccessPolicyOutput values.
// You can construct a concrete instance of `TwingateWebAppResourceAccessGroupAccessPolicyInput` via:
//
//	TwingateWebAppResourceAccessGroupAccessPolicyArgs{...}
type TwingateWebAppResourceAccessGroupAccessPolicyInput interface {
	pulumi.Input

	ToTwingateWebAppResourceAccessGroupAccessPolicyOutput() TwingateWebAppResourceAccessGroupAccessPolicyOutput
	ToTwingateWebAppResourceAccessGroupAccessPolicyOutputWithContext(context.Context) TwingateWebAppResourceAccessGroupAccessPolicyOutput
}

type TwingateWebAppResourceAccessGroupAccessPolicyArgs struct {
	// This will set the approval model for the policy. The valid values are `AUTOMATIC` and `MANUAL`.
	ApprovalMode pulumi.StringPtrInput `pulumi:"approvalMode"`
	// This will set the access duration for the policy. Duration must be between 1 hour and 365 days. Examples of valid values include `1h` and `2d`.
	Duration pulumi.StringPtrInput `pulumi:"duration"`
...
func (TwingateWebAppResourceAccessGroupAccessPolicyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*TwingateWebAppResourceAccessGroupAccessPolicy)(nil)).Elem()
}

func (i TwingateWebAppResourceAccessGroupAccessPolicyArgs) ToTwingateWebAppResourceAccessGroupAccessPolicyOutput() TwingateWebAppResourceAccessGroupAccessPolicyOutput {
	return i.ToTwingateWebAppResourceAccessGroupAccessPolicyOutputWithContext(context.Background())
}

func (i TwingateWebAppResourceAccessGroupAccessPolicyArgs) ToTwingateWebAppResourceAccessGroupAccessPolicyOutputWithContext(ctx context.Context) TwingateWebAppResourceAccessGroupAccessPolicyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TwingateWebAppResourceAccessGroupAccessPolicyOutput)
}

// TwingateWebAppResourceAccessGroupAccessPolicyArrayInput is an input type that accepts TwingateWebAppResourceAccessGroupAccessPolicyArray and TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput values.
// You can construct a concrete instance of `TwingateWebAppResourceAccessGroupAccessPolicyArrayInput` via:
//
//	TwingateWebAppResourceAccessGroupAccessPolicyArray{ TwingateWebAppResourceAccessGroupAccessPolicyArgs{...} }
type TwingateWebAppResourceAccessGroupAccessPolicyArrayInput interface {
	pulumi.Input

	ToTwingateWebAppResourceAccessGroupAccessPolicyArrayOutput() TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput
	ToTwingateWebAppResourceAccessGroupAccessPolicyArrayOutputWithContext(context.Context) TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput
}

type TwingateWebAppResourceAccessGroupAccessPolicyArray []TwingateWebAppResourceAccessGroupAccessPolicyInput

func (TwingateWebAppResourceAccessGroupAccessPolicyArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]TwingateWebAppResourceAccessGroupAccessPolicy)(nil)).Elem()
}

func (i TwingateWebAppResourceAccessGroupAccessPolicyArray) ToTwingateWebAppResourceAccessGroupAccessPolicyArrayOutput() TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput {
	return i.ToTwingateWebAppResourceAccessGroupAccessPolicyArrayOutputWithContext(context.Background())
}

func (i TwingateWebAppResourceAccessGroupAccessPolicyArray) ToTwingateWebAppResourceAccessGroupAccessPolicyArrayOutputWithContext(ctx context.Context) TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput)
}

type TwingateWebAppResourceAccessGroupAccessPolicyOutput struct{ *pulumi.OutputState }

func (TwingateWebAppResourceAccessGroupAccessPolicyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*TwingateWebAppResourceAccessGroupAccessPolicy)(nil)).Elem()
}

func (o TwingateWebAppResourceAccessGroupAccessPolicyOutput) ToTwingateWebAppResourceAccessGroupAccessPolicyOutput() TwingateWebAppResourceAccessGroupAccessPolicyOutput {
	return o
}

func (o TwingateWebAppResourceAccessGroupAccessPolicyOutput) ToTwingateWebAppResourceAccessGroupAccessPolicyOutputWithContext(ctx context.Context) TwingateWebAppResourceAccessGroupAccessPolicyOutput {
	return o
}

// This will set the approval model for the policy. The valid values are `AUTOMATIC` and `MANUAL`.
func (o TwingateWebAppResourceAccessGroupAccessPolicyOutput) ApprovalMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v TwingateWebAppResourceAccessGroupAccessPolicy) *string { return v.ApprovalMode }).(pulumi.StringPtrOutput)
}

// This will set the access duration for the policy. Duration must be between 1 hour and 365 days. Examples of valid values include `1h` and `2d`.
func (o TwingateWebAppResourceAccessGroupAccessPolicyOutput) Duration() pulumi.StringPtrOutput {
	return o.ApplyT(func(v TwingateWebAppResourceAccessGroupAccessPolicy) *string { return v.Duration }).(pulumi.StringPtrOutput)
}

// This will set the accessPolicy mode for the policy. The valid values are `MANUAL`, `AUTO_LOCK` and `ACCESS_REQUEST`.
func (o TwingateWebAppResourceAccessGroupAccessPolicyOutput) Mode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v TwingateWebAppResourceAccessGroupAccessPolicy) *string { return v.Mode }).(pulumi.StringPtrOutput)
}

type TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput struct{ *pulumi.OutputState }

func (TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]TwingateWebAppResourceAccessGroupAccessPolicy)(nil)).Elem()
}

func (o TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput) ToTwingateWebAppResourceAccessGroupAccessPolicyArrayOutput() TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput {
	return o
}

func (o TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput) ToTwingateWebAppResourceAccessGroupAccessPolicyArrayOutputWithContext(ctx context.Context) TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput {
	return o
}

func (o TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput) Index(i pulumi.IntInput) TwingateWebAppResourceAccessGroupAccessPolicyOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) TwingateWebAppResourceAccessGroupAccessPolicy {
		return vs[0].([]TwingateWebAppResourceAccessGroupAccessPolicy)[vs[1].(int)]
	}).(TwingateWebAppResourceAccessGroupAccessPolicyOutput)
}

type TwingateWebAppResourceAccessPolicy struct {
	// This will set the approval model for the policy. The valid values are `AUTOMATIC` and `MANUAL`.
	ApprovalMode *string `pulumi:"approvalMode"`
	// This will set the access duration for the policy. Duration must be between 1 hour and 365 days. Examples of valid values include `1h` and `2d`.
	Duration *string `pulumi:"duration"`
...
// TwingateWebAppResourceAccessPolicyInput is an input type that accepts TwingateWebAppResourceAccessPolicyArgs and TwingateWebAppResourceAccessPolicyOutput values.
// You can construct a concrete instance of `TwingateWebAppResourceAccessPolicyInput` via:
//
//	TwingateWebAppResourceAccessPolicyArgs{...}
type TwingateWebAppResourceAccessPolicyInput interface {
	pulumi.Input

	ToTwingateWebAppResourceAccessPolicyOutput() TwingateWebAppResourceAccessPolicyOutput
	ToTwingateWebAppResourceAccessPolicyOutputWithContext(context.Context) TwingateWebAppResourceAccessPolicyOutput
}

type TwingateWebAppResourceAccessPolicyArgs struct {
	// This will set the approval model for the policy. The valid values are `AUTOMATIC` and `MANUAL`.
	ApprovalMode pulumi.StringPtrInput `pulumi:"approvalMode"`
	// This will set the access duration for the policy. Duration must be between 1 hour and 365 days. Examples of valid values include `1h` and `2d`.
	Duration pulumi.StringPtrInput `pulumi:"duration"`
...
func (TwingateWebAppResourceAccessPolicyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*TwingateWebAppResourceAccessPolicy)(nil)).Elem()
}

func (i TwingateWebAppResourceAccessPolicyArgs) ToTwingateWebAppResourceAccessPolicyOutput() TwingateWebAppResourceAccessPolicyOutput {
	return i.ToTwingateWebAppResourceAccessPolicyOutputWithContext(context.Background())
}

func (i TwingateWebAppResourceAccessPolicyArgs) ToTwingateWebAppResourceAccessPolicyOutputWithContext(ctx context.Context) TwingateWebAppResourceAccessPolicyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TwingateWebAppResourceAccessPolicyOutput)
}

// TwingateWebAppResourceAccessPolicyArrayInput is an input type that accepts TwingateWebAppResourceAccessPolicyArray and TwingateWebAppResourceAccessPolicyArrayOutput values.
// You can construct a concrete instance of `TwingateWebAppResourceAccessPolicyArrayInput` via:
//
//	TwingateWebAppResourceAccessPolicyArray{ TwingateWebAppResourceAccessPolicyArgs{...} }
type TwingateWebAppResourceAccessPolicyArrayInput interface {
	pulumi.Input

	ToTwingateWebAppResourceAccessPolicyArrayOutput() TwingateWebAppResourceAccessPolicyArrayOutput
	ToTwingateWebAppResourceAccessPolicyArrayOutputWithContext(context.Context) TwingateWebAppResourceAccessPolicyArrayOutput
}

type TwingateWebAppResourceAccessPolicyArray []TwingateWebAppResourceAccessPolicyInput

func (TwingateWebAppResourceAccessPolicyArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]TwingateWebAppResourceAccessPolicy)(nil)).Elem()
}

func (i TwingateWebAppResourceAccessPolicyArray) ToTwingateWebAppResourceAccessPolicyArrayOutput() TwingateWebAppResourceAccessPolicyArrayOutput {
	return i.ToTwingateWebAppResourceAccessPolicyArrayOutputWithContext(context.Background())
}

func (i TwingateWebAppResourceAccessPolicyArray) ToTwingateWebAppResourceAccessPolicyArrayOutputWithContext(ctx context.Context) TwingateWebAppResourceAccessPolicyArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TwingateWebAppResourceAccessPolicyArrayOutput)
}

type TwingateWebAppResourceAccessPolicyOutput struct{ *pulumi.OutputState }

func (TwingateWebAppResourceAccessPolicyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*TwingateWebAppResourceAccessPolicy)(nil)).Elem()
}

func (o TwingateWebAppResourceAccessPolicyOutput) ToTwingateWebAppResourceAccessPolicyOutput() TwingateWebAppResourceAccessPolicyOutput {
	return o
}

func (o TwingateWebAppResourceAccessPolicyOutput) ToTwingateWebAppResourceAccessPolicyOutputWithContext(ctx context.Context) TwingateWebAppResourceAccessPolicyOutput {
	return o
}

// This will set the approval model for the policy. The valid values are `AUTOMATIC` and `MANUAL`.
func (o TwingateWebAppResourceAccessPolicyOutput) ApprovalMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v TwingateWebAppResourceAccessPolicy) *string { return v.ApprovalMode }).(pulumi.StringPtrOutput)
}

// This will set the access duration for the policy. Duration must be between 1 hour and 365 days. Examples of valid values include `1h` and `2d`.
func (o TwingateWebAppResourceAccessPolicyOutput) Duration() pulumi.StringPtrOutput {
	return o.ApplyT(func(v TwingateWebAppResourceAccessPolicy) *string { return v.Duration }).(pulumi.StringPtrOutput)
}

// This will set the accessPolicy mode for the policy. The valid values are `MANUAL`, `AUTO_LOCK` and `ACCESS_REQUEST`.
func (o TwingateWebAppResourceAccessPolicyOutput) Mode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v TwingateWebAppResourceAccessPolicy) *string { return v.Mode }).(pulumi.StringPtrOutput)
}

type TwingateWebAppResourceAccessPolicyArrayOutput struct{ *pulumi.OutputState }

func (TwingateWebAppResourceAccessPolicyArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]TwingateWebAppResourceAccessPolicy)(nil)).Elem()
}

func (o TwingateWebAppResourceAccessPolicyArrayOutput) ToTwingateWebAppResourceAccessPolicyArrayOutput() TwingateWebAppResourceAccessPolicyArrayOutput {
	return o
}

func (o TwingateWebAppResourceAccessPolicyArrayOutput) ToTwingateWebAppResourceAccessPolicyArrayOutputWithContext(ctx context.Context) TwingateWebAppResourceAccessPolicyArrayOutput {
	return o
}

func (o TwingateWebAppResourceAccessPolicyArrayOutput) Index(i pulumi.IntInput) TwingateWebAppResourceAccessPolicyOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) TwingateWebAppResourceAccessPolicy {
		return vs[0].([]TwingateWebAppResourceAccessPolicy)[vs[1].(int)]
	}).(TwingateWebAppResourceAccessPolicyOutput)
}

type TwingateWebAppResourceDownstream struct {
	// The port number. Must be between 1 and 65535 inclusive.
	Port int `pulumi:"port"`
}

// TwingateWebAppResourceDownstreamInput is an input type that accepts TwingateWebAppResourceDownstreamArgs and TwingateWebAppResourceDownstreamOutput values.
// You can construct a concrete instance of `TwingateWebAppResourceDownstreamInput` via:
//
//	TwingateWebAppResourceDownstreamArgs{...}
type TwingateWebAppResourceDownstreamInput interface {
	pulumi.Input

	ToTwingateWebAppResourceDownstreamOutput() TwingateWebAppResourceDownstreamOutput
	ToTwingateWebAppResourceDownstreamOutputWithContext(context.Context) TwingateWebAppResourceDownstreamOutput
}

type TwingateWebAppResourceDownstreamArgs struct {
	// The port number. Must be between 1 and 65535 inclusive.
	Port pulumi.IntInput `pulumi:"port"`
}

func (TwingateWebAppResourceDownstreamArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*TwingateWebAppResourceDownstream)(nil)).Elem()
}

func (i TwingateWebAppResourceDownstreamArgs) ToTwingateWebAppResourceDownstreamOutput() TwingateWebAppResourceDownstreamOutput {
	return i.ToTwingateWebAppResourceDownstreamOutputWithContext(context.Background())
}

func (i TwingateWebAppResourceDownstreamArgs) ToTwingateWebAppResourceDownstreamOutputWithContext(ctx context.Context) TwingateWebAppResourceDownstreamOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TwingateWebAppResourceDownstreamOutput)
}

func (i TwingateWebAppResourceDownstreamArgs) ToTwingateWebAppResourceDownstreamPtrOutput() TwingateWebAppResourceDownstreamPtrOutput {
	return i.ToTwingateWebAppResourceDownstreamPtrOutputWithContext(context.Background())
}

func (i TwingateWebAppResourceDownstreamArgs) ToTwingateWebAppResourceDownstreamPtrOutputWithContext(ctx context.Context) TwingateWebAppResourceDownstreamPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TwingateWebAppResourceDownstreamOutput).ToTwingateWebAppResourceDownstreamPtrOutputWithContext(ctx)
}

// TwingateWebAppResourceDownstreamPtrInput is an input type that accepts TwingateWebAppResourceDownstreamArgs, TwingateWebAppResourceDownstreamPtr and TwingateWebAppResourceDownstreamPtrOutput values.
// You can construct a concrete instance of `TwingateWebAppResourceDownstreamPtrInput` via:
//
//	        TwingateWebAppResourceDownstreamArgs{...}
//
//	or:
//
//	        nil
type TwingateWebAppResourceDownstreamPtrInput interface {
	pulumi.Input

	ToTwingateWebAppResourceDownstreamPtrOutput() TwingateWebAppResourceDownstreamPtrOutput
	ToTwingateWebAppResourceDownstreamPtrOutputWithContext(context.Context) TwingateWebAppResourceDownstreamPtrOutput
}

type twingateWebAppResourceDownstreamPtrType TwingateWebAppResourceDownstreamArgs

func TwingateWebAppResourceDownstreamPtr(v *TwingateWebAppResourceDownstreamArgs) TwingateWebAppResourceDownstreamPtrInput {
	return (*twingateWebAppResourceDownstreamPtrType)(v)
}

func (*twingateWebAppResourceDownstreamPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**TwingateWebAppResourceDownstream)(nil)).Elem()
}

func (i *twingateWebAppResourceDownstreamPtrType) ToTwingateWebAppResourceDownstreamPtrOutput() TwingateWebAppResourceDownstreamPtrOutput {
	return i.ToTwingateWebAppResourceDownstreamPtrOutputWithContext(context.Background())
}

func (i *twingateWebAppResourceDownstreamPtrType) ToTwingateWebAppResourceDownstreamPtrOutputWithContext(ctx context.Context) TwingateWebAppResourceDownstreamPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TwingateWebAppResourceDownstreamPtrOutput)
}

type TwingateWebAppResourceDownstreamOutput struct{ *pulumi.OutputState }

func (TwingateWebAppResourceDownstreamOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*TwingateWebAppResourceDownstream)(nil)).Elem()
}

func (o TwingateWebAppResourceDownstreamOutput) ToTwingateWebAppResourceDownstreamOutput() TwingateWebAppResourceDownstreamOutput {
	return o
}

func (o TwingateWebAppResourceDownstreamOutput) ToTwingateWebAppResourceDownstreamOutputWithContext(ctx context.Context) TwingateWebAppResourceDownstreamOutput {
	return o
}

func (o TwingateWebAppResourceDownstreamOutput) ToTwingateWebAppResourceDownstreamPtrOutput() TwingateWebAppResourceDownstreamPtrOutput {
	return o.ToTwingateWebAppResourceDownstreamPtrOutputWithContext(context.Background())
}

func (o TwingateWebAppResourceDownstreamOutput) ToTwingateWebAppResourceDownstreamPtrOutputWithContext(ctx context.Context) TwingateWebAppResourceDownstreamPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v TwingateWebAppResourceDownstream) *TwingateWebAppResourceDownstream {
		return &v
	}).(TwingateWebAppResourceDownstreamPtrOutput)
}

// The port number. Must be between 1 and 65535 inclusive.
func (o TwingateWebAppResourceDownstreamOutput) Port() pulumi.IntOutput {
	return o.ApplyT(func(v TwingateWebAppResourceDownstream) int { return v.Port }).(pulumi.IntOutput)
}

type TwingateWebAppResourceDownstreamPtrOutput struct{ *pulumi.OutputState }

func (TwingateWebAppResourceDownstreamPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**TwingateWebAppResourceDownstream)(nil)).Elem()
}

func (o TwingateWebAppResourceDownstreamPtrOutput) ToTwingateWebAppResourceDownstreamPtrOutput() TwingateWebAppResourceDownstreamPtrOutput {
	return o
}

func (o TwingateWebAppResourceDownstreamPtrOutput) ToTwingateWebAppResourceDownstreamPtrOutputWithContext(ctx context.Context) TwingateWebAppResourceDownstreamPtrOutput {
	return o
}

func (o TwingateWebAppResourceDownstreamPtrOutput) Elem() TwingateWebAppResourceDownstreamOutput {
	return o.ApplyT(func(v *TwingateWebAppResourceDownstream) TwingateWebAppResourceDownstream {
		if v != nil {
			return *v
		}
		var ret TwingateWebAppResourceDownstream
		return ret
	}).(TwingateWebAppResourceDownstreamOutput)
}

// The port number. Must be between 1 and 65535 inclusive.
func (o TwingateWebAppResourceDownstreamPtrOutput) Port() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *TwingateWebAppResourceDownstream) *int {
		if v == nil {
			return nil
		}
		return &v.Port
...
type TwingateWebAppResourceUpstream struct {
	// The port number. Must be between 1 and 65535 inclusive.
	Port int `pulumi:"port"`
}

// TwingateWebAppResourceUpstreamInput is an input type that accepts TwingateWebAppResourceUpstreamArgs and TwingateWebAppResourceUpstreamOutput values.
// You can construct a concrete instance of `TwingateWebAppResourceUpstreamInput` via:
//
//	TwingateWebAppResourceUpstreamArgs{...}
type TwingateWebAppResourceUpstreamInput interface {
	pulumi.Input

	ToTwingateWebAppResourceUpstreamOutput() TwingateWebAppResourceUpstreamOutput
	ToTwingateWebAppResourceUpstreamOutputWithContext(context.Context) TwingateWebAppResourceUpstreamOutput
}

type TwingateWebAppResourceUpstreamArgs struct {
	// The port number. Must be between 1 and 65535 inclusive.
	Port pulumi.IntInput `pulumi:"port"`
}

func (TwingateWebAppResourceUpstreamArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*TwingateWebAppResourceUpstream)(nil)).Elem()
}

func (i TwingateWebAppResourceUpstreamArgs) ToTwingateWebAppResourceUpstreamOutput() TwingateWebAppResourceUpstreamOutput {
	return i.ToTwingateWebAppResourceUpstreamOutputWithContext(context.Background())
}

func (i TwingateWebAppResourceUpstreamArgs) ToTwingateWebAppResourceUpstreamOutputWithContext(ctx context.Context) TwingateWebAppResourceUpstreamOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TwingateWebAppResourceUpstreamOutput)
}

func (i TwingateWebAppResourceUpstreamArgs) ToTwingateWebAppResourceUpstreamPtrOutput() TwingateWebAppResourceUpstreamPtrOutput {
	return i.ToTwingateWebAppResourceUpstreamPtrOutputWithContext(context.Background())
}

func (i TwingateWebAppResourceUpstreamArgs) ToTwingateWebAppResourceUpstreamPtrOutputWithContext(ctx context.Context) TwingateWebAppResourceUpstreamPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TwingateWebAppResourceUpstreamOutput).ToTwingateWebAppResourceUpstreamPtrOutputWithContext(ctx)
}

// TwingateWebAppResourceUpstreamPtrInput is an input type that accepts TwingateWebAppResourceUpstreamArgs, TwingateWebAppResourceUpstreamPtr and TwingateWebAppResourceUpstreamPtrOutput values.
// You can construct a concrete instance of `TwingateWebAppResourceUpstreamPtrInput` via:
//
//	        TwingateWebAppResourceUpstreamArgs{...}
//
//	or:
//
//	        nil
type TwingateWebAppResourceUpstreamPtrInput interface {
	pulumi.Input

	ToTwingateWebAppResourceUpstreamPtrOutput() TwingateWebAppResourceUpstreamPtrOutput
	ToTwingateWebAppResourceUpstreamPtrOutputWithContext(context.Context) TwingateWebAppResourceUpstreamPtrOutput
}

type twingateWebAppResourceUpstreamPtrType TwingateWebAppResourceUpstreamArgs

func TwingateWebAppResourceUpstreamPtr(v *TwingateWebAppResourceUpstreamArgs) TwingateWebAppResourceUpstreamPtrInput {
	return (*twingateWebAppResourceUpstreamPtrType)(v)
}

func (*twingateWebAppResourceUpstreamPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**TwingateWebAppResourceUpstream)(nil)).Elem()
}

func (i *twingateWebAppResourceUpstreamPtrType) ToTwingateWebAppResourceUpstreamPtrOutput() TwingateWebAppResourceUpstreamPtrOutput {
	return i.ToTwingateWebAppResourceUpstreamPtrOutputWithContext(context.Background())
}

func (i *twingateWebAppResourceUpstreamPtrType) ToTwingateWebAppResourceUpstreamPtrOutputWithContext(ctx context.Context) TwingateWebAppResourceUpstreamPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TwingateWebAppResourceUpstreamPtrOutput)
}

type TwingateWebAppResourceUpstreamOutput struct{ *pulumi.OutputState }

func (TwingateWebAppResourceUpstreamOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*TwingateWebAppResourceUpstream)(nil)).Elem()
}

func (o TwingateWebAppResourceUpstreamOutput) ToTwingateWebAppResourceUpstreamOutput() TwingateWebAppResourceUpstreamOutput {
	return o
}

func (o TwingateWebAppResourceUpstreamOutput) ToTwingateWebAppResourceUpstreamOutputWithContext(ctx context.Context) TwingateWebAppResourceUpstreamOutput {
	return o
}

func (o TwingateWebAppResourceUpstreamOutput) ToTwingateWebAppResourceUpstreamPtrOutput() TwingateWebAppResourceUpstreamPtrOutput {
	return o.ToTwingateWebAppResourceUpstreamPtrOutputWithContext(context.Background())
}

func (o TwingateWebAppResourceUpstreamOutput) ToTwingateWebAppResourceUpstreamPtrOutputWithContext(ctx context.Context) TwingateWebAppResourceUpstreamPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v TwingateWebAppResourceUpstream) *TwingateWebAppResourceUpstream {
		return &v
	}).(TwingateWebAppResourceUpstreamPtrOutput)
}

// The port number. Must be between 1 and 65535 inclusive.
func (o TwingateWebAppResourceUpstreamOutput) Port() pulumi.IntOutput {
	return o.ApplyT(func(v TwingateWebAppResourceUpstream) int { return v.Port }).(pulumi.IntOutput)
}

type TwingateWebAppResourceUpstreamPtrOutput struct{ *pulumi.OutputState }

func (TwingateWebAppResourceUpstreamPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**TwingateWebAppResourceUpstream)(nil)).Elem()
}

func (o TwingateWebAppResourceUpstreamPtrOutput) ToTwingateWebAppResourceUpstreamPtrOutput() TwingateWebAppResourceUpstreamPtrOutput {
	return o
}

func (o TwingateWebAppResourceUpstreamPtrOutput) ToTwingateWebAppResourceUpstreamPtrOutputWithContext(ctx context.Context) TwingateWebAppResourceUpstreamPtrOutput {
	return o
}

func (o TwingateWebAppResourceUpstreamPtrOutput) Elem() TwingateWebAppResourceUpstreamOutput {
	return o.ApplyT(func(v *TwingateWebAppResourceUpstream) TwingateWebAppResourceUpstream {
		if v != nil {
			return *v
		}
		var ret TwingateWebAppResourceUpstream
		return ret
	}).(TwingateWebAppResourceUpstreamOutput)
}

// The port number. Must be between 1 and 65535 inclusive.
func (o TwingateWebAppResourceUpstreamPtrOutput) Port() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *TwingateWebAppResourceUpstream) *int {
		if v == nil {
			return nil
		}
		return &v.Port
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*TwingateWebAppResourceAccessGroupInput)(nil)).Elem(), TwingateWebAppResourceAccessGroupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TwingateWebAppResourceAccessGroupArrayInput)(nil)).Elem(), TwingateWebAppResourceAccessGroupArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TwingateWebAppResourceAccessGroupAccessPolicyInput)(nil)).Elem(), TwingateWebAppResourceAccessGroupAccessPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TwingateWebAppResourceAccessGroupAccessPolicyArrayInput)(nil)).Elem(), TwingateWebAppResourceAccessGroupAccessPolicyArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TwingateWebAppResourceAccessPolicyInput)(nil)).Elem(), TwingateWebAppResourceAccessPolicyArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TwingateWebAppResourceAccessPolicyArrayInput)(nil)).Elem(), TwingateWebAppResourceAccessPolicyArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*TwingateWebAppResourceDownstreamInput)(nil)).Elem(), TwingateWebAppResourceDownstreamArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TwingateWebAppResourceDownstreamPtrInput)(nil)).Elem(), TwingateWebAppResourceDownstreamArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TwingateWebAppResourceUpstreamInput)(nil)).Elem(), TwingateWebAppResourceUpstreamArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*TwingateWebAppResourceUpstreamPtrInput)(nil)).Elem(), TwingateWebAppResourceUpstreamArgs{})
	...
	pulumi.RegisterOutputType(TwingateWebAppResourceAccessGroupOutput{})
	pulumi.RegisterOutputType(TwingateWebAppResourceAccessGroupArrayOutput{})
	pulumi.RegisterOutputType(TwingateWebAppResourceAccessGroupAccessPolicyOutput{})
	pulumi.RegisterOutputType(TwingateWebAppResourceAccessGroupAccessPolicyArrayOutput{})
	pulumi.RegisterOutputType(TwingateWebAppResourceAccessPolicyOutput{})
	pulumi.RegisterOutputType(TwingateWebAppResourceAccessPolicyArrayOutput{})
	pulumi.RegisterOutputType(TwingateWebAppResourceDownstreamOutput{})
	pulumi.RegisterOutputType(TwingateWebAppResourceDownstreamPtrOutput{})
	pulumi.RegisterOutputType(TwingateWebAppResourceUpstreamOutput{})
	pulumi.RegisterOutputType(TwingateWebAppResourceUpstreamPtrOutput{})
