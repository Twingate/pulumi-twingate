...
class TwingateConnectorArgs:
    def __init__(__self__, *,
                 ...
                 status_updates_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a TwingateConnector resource.
        :param pulumi.Input[builtins.str] remote_network_id: The ID of the Remote Network the Connector is attached to.
        :param pulumi.Input[builtins.str] name: Name of the Connector, if not provided one will be generated.
        :param pulumi.Input[builtins.bool] status_updates_enabled: Determines whether status notifications are enabled for the Connector. Default is `true`.
        """
    ...
    def status_updates_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def status_updates_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _TwingateConnectorState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] hostname: The hostname of the machine hosting the Connector.
        :param pulumi.Input[builtins.str] name: Name of the Connector, if not provided one will be generated.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_ips: The Connector's private IP addresses.
        :param pulumi.Input[builtins.str] public_ip: The Connector's public IP address.
        :param pulumi.Input[builtins.str] remote_network_id: The ID of the Remote Network the Connector is attached to.
        :param pulumi.Input[builtins.str] state: The Connector's state. One of `ALIVE`, `DEAD_NO_HEARTBEAT`, `DEAD_HEARTBEAT_TOO_OLD` or `DEAD_NO_RELAYS`.
        :param pulumi.Input[builtins.bool] status_updates_enabled: Determines whether status notifications are enabled for the Connector. Default is `true`.
        :param pulumi.Input[builtins.str] version: The Connector's version.
        """
...
class TwingateConnector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            status_updates_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'TwingateConnector':
        """
    ...
    @property
    @pulumi.getter(name="statusUpdatesEnabled")
    def status_updates_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Determines whether status notifications are enabled for the Connector. Default is `true`.
        """
        return pulumi.get(self, "status_updates_enabled")
