...
class TwingateGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] security_policy_id: Defines which Security Policy applies to this Group. The Security Policy ID can be obtained from the `get_twingate_security_policy` and `get_twingate_security_policies` data sources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_ids: List of User IDs that have permission to access the Group.
        """
...
class TwingateGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            user_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'TwingateGroup':
        """
