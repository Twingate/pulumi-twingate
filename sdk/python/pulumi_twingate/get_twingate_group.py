...
def get_twingate_group(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The ID of the Group. The ID for the Group can be obtained from the Admin API or the URL string in the Admin Console.
    """
    __args__ = dict()
    __args__['id'] = id
