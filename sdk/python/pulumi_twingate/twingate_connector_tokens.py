...
class TwingateConnectorTokensArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connector_id: The ID of the parent Connector
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. Use this to automatically rotate Connector tokens on a schedule.
        """
...
class _TwingateConnectorTokensState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_token: The Access Token of the parent Connector
        :param pulumi.Input[builtins.str] connector_id: The ID of the parent Connector
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. Use this to automatically rotate Connector tokens on a schedule.
        :param pulumi.Input[builtins.str] refresh_token: The Refresh Token of the parent Connector
        """
...
class TwingateConnectorTokens(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            connector_id: Optional[pulumi.Input[builtins.str]] = None,
            keepers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            refresh_token: Optional[pulumi.Input[builtins.str]] = None) -> 'TwingateConnectorTokens':
        """
