...
def get_twingate_user(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The ID of the User. The ID for the User can be obtained from the Admin API or the URL string in the Admin Console.
    """
    __args__ = dict()
    __args__['id'] = id
