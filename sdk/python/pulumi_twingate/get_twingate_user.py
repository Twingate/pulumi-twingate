...
def get_twingate_user(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the User. The ID for the User can be obtained from the Admin API or the URL string in the Admin Console.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_twingate_user_output(id: Optional[pulumi.Input[builtins.str]] = None,
