...
class TwingateServiceAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the Service Account in Twingate
        """
        if name is not None:
...
@pulumi.type_token("twingate:index/twingateServiceAccount:TwingateServiceAccount")
class TwingateServiceAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'TwingateServiceAccount':
        """
