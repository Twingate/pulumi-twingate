...
def get_twingate_connector(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The ID of the Connector. The ID for the Connector can be obtained from the Admin API or the URL string in the Admin Console.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_twingate_connector_output(id: Optional[pulumi.Input[_builtins.str]] = None,
