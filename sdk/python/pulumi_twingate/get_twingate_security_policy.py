...
def get_twingate_security_policy(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Return a Security Policy by its ID. The ID for the Security Policy can be obtained from the Admin API or the URL string in the Admin Console.
...
def get_twingate_security_policy_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
