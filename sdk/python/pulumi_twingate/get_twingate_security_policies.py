...
class GetTwingateSecurityPoliciesResult:
    ...
    def name_exclude(self) -> Optional[builtins.str]:
        """
    ...
    def name_regexp(self) -> Optional[builtins.str]:
        """
...
def get_twingate_security_policies(name: Optional[builtins.str] = None,
                                   name_contains: Optional[builtins.str] = None,
                                   name_exclude: Optional[builtins.str] = None,
                                   name_prefix: Optional[builtins.str] = None,
                                   name_regexp: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Returns only security policies that exactly match this name. If no options are passed it will return all security policies. Only one option can be used at a time.
    :param builtins.str name_contains: Match when the value exist in the name of the security policy.
    :param builtins.str name_exclude: Match when the exact value does not exist in the name of the security policy.
    :param builtins.str name_prefix: The name of the security policy must start with the value.
    :param builtins.str name_regexp: The regular expression match of the name of the security policy.
    :param builtins.str name_suffix: The name of the security policy must end with the value.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_twingate_security_policies_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          name_contains: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          name_exclude: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          name_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          name_regexp: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          name_suffix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
