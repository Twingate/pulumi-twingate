...
def get_twingate_groups(is_active: Optional[builtins.bool] = None,
    ...
    :param builtins.bool is_active: Returns only Groups matching the specified state.
    :param builtins.str name: Returns only groups that exactly match this name. If no options are passed it will return all resources. Only one option can be used at a time.
    :param builtins.str name_contains: Match when the value exist in the name of the group.
    :param builtins.str name_exclude: Match when the exact value does not exist in the name of the group.
    :param builtins.str name_prefix: The name of the group must start with the value.
    :param builtins.str name_regexp: The regular expression match of the name of the group.
    :param builtins.str name_suffix: The name of the group must end with the value.
    :param Sequence[builtins.str] types: Returns groups that match a list of types. valid types: `MANUAL`, `SYNCED`, `SYSTEM`.
    """
    __args__ = dict()
...
def get_twingate_groups_output(is_active: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
