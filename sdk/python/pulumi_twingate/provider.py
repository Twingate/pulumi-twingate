...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network: Your Twingate network ID for API operations. You can find it in the Admin Console URL, for example:
               `autoco.twingate.com`, where `autoco` is your network ID Alternatively, this can be specified using the TWINGATE_NETWORK
               environment variable.
        :param pulumi.Input[builtins.str] url: The default is 'twingate.com' This is optional and shouldn't be changed under normal circumstances.
        """
    ...
    def http_max_retry(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def http_max_retry(self, value: Optional[pulumi.Input[builtins.int]]):
...
@pulumi.type_token("pulumi:providers:twingate")
class Provider(pulumi.ProviderResource):
    ...
    def terraform_config(__self__) -> pulumi.Output['Provider.TerraformConfigResult']:
        ...
        return pulumi.runtime.call('pulumi:providers:twingate/terraformConfig', __args__, res=__self__, typ=Provider.TerraformConfigResult)
