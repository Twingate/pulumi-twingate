...
def get_twingate_remote_network(id: Optional[builtins.str] = None,
...
def get_twingate_remote_network_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
