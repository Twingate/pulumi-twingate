...
class GetTwingateUsersResult:
    ...
    def email_contains(self) -> Optional[builtins.str]:
        """
    ...
    def email_exclude(self) -> Optional[builtins.str]:
        """
    ...
    def email_prefix(self) -> Optional[builtins.str]:
        """
    ...
    def email_regexp(self) -> Optional[builtins.str]:
        """
    ...
    def email_suffix(self) -> Optional[builtins.str]:
        """
    ...
    def first_name_contains(self) -> Optional[builtins.str]:
        """
    ...
    def first_name_exclude(self) -> Optional[builtins.str]:
        """
    ...
    def first_name_prefix(self) -> Optional[builtins.str]:
        """
    ...
    def first_name_regexp(self) -> Optional[builtins.str]:
        """
    ...
    def first_name_suffix(self) -> Optional[builtins.str]:
        """
    ...
    def last_name_contains(self) -> Optional[builtins.str]:
        """
    ...
    def last_name_exclude(self) -> Optional[builtins.str]:
        """
    ...
    def last_name_prefix(self) -> Optional[builtins.str]:
        """
    ...
    def last_name_regexp(self) -> Optional[builtins.str]:
        """
    ...
    def last_name_suffix(self) -> Optional[builtins.str]:
        """
...
def get_twingate_users(email: Optional[builtins.str] = None,
                       email_contains: Optional[builtins.str] = None,
                       email_exclude: Optional[builtins.str] = None,
                       email_prefix: Optional[builtins.str] = None,
                       email_regexp: Optional[builtins.str] = None,
                       email_suffix: Optional[builtins.str] = None,
                       first_name: Optional[builtins.str] = None,
                       first_name_contains: Optional[builtins.str] = None,
                       first_name_exclude: Optional[builtins.str] = None,
                       first_name_prefix: Optional[builtins.str] = None,
                       first_name_regexp: Optional[builtins.str] = None,
                       first_name_suffix: Optional[builtins.str] = None,
                       last_name: Optional[builtins.str] = None,
                       last_name_contains: Optional[builtins.str] = None,
                       last_name_exclude: Optional[builtins.str] = None,
                       last_name_prefix: Optional[builtins.str] = None,
                       last_name_regexp: Optional[builtins.str] = None,
                       last_name_suffix: Optional[builtins.str] = None,
    ...
    :param builtins.str email: Returns only users that exactly match this email.
    :param builtins.str email_contains: Match when the value exist in the email of the user.
    :param builtins.str email_exclude: Match when the value does not exist in the email of the user.
    :param builtins.str email_prefix: The email of the user must start with the value.
    :param builtins.str email_regexp: The regular expression match of the email of the user.
    :param builtins.str email_suffix: The email of the user must end with the value.
    :param builtins.str first_name: Returns only users that exactly match the first name.
    :param builtins.str first_name_contains: Match when the value exist in the first name of the user.
    :param builtins.str first_name_exclude: Match when the value does not exist in the first name of the user.
    :param builtins.str first_name_prefix: The first name of the user must start with the value.
    :param builtins.str first_name_regexp: The regular expression match of the first name of the user.
    :param builtins.str first_name_suffix: The first name of the user must end with the value.
    :param builtins.str last_name: Returns only users that exactly match the last name.
    :param builtins.str last_name_contains: Match when the value exist in the last name of the user.
    :param builtins.str last_name_exclude: Match when the value does not exist in the last name of the user.
    :param builtins.str last_name_prefix: The last name of the user must start with the value.
    :param builtins.str last_name_regexp: The regular expression match of the last name of the user.
    :param builtins.str last_name_suffix: The last name of the user must end with the value.
    :param Sequence[builtins.str] roles: Returns users that match a list of roles. Valid roles: `ADMIN`, `DEVOPS`, `SUPPORT`, `MEMBER`.
    """
    __args__ = dict()
...
def get_twingate_users_output(email: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              email_contains: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              email_exclude: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              email_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              email_regexp: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              email_suffix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              first_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              first_name_contains: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              first_name_exclude: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              first_name_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              first_name_regexp: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              first_name_suffix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              last_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              last_name_contains: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              last_name_exclude: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              last_name_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              last_name_regexp: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              last_name_suffix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              roles: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
