...
class _TwingateServiceAccountKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the Service Key
        :param pulumi.Input[_builtins.str] service_account_id: The id of the Service Account
        :param pulumi.Input[_builtins.str] token: Autogenerated Service Key token. Used to configure a Twingate Client running in headless mode.
        """
        if expiration_time is not None:
            pulumi.set(__self__, "expiration_time", expiration_time)
...
class TwingateServiceAccountKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            service_account_id: Optional[pulumi.Input[_builtins.str]] = None,
            token: Optional[pulumi.Input[_builtins.str]] = None) -> 'TwingateServiceAccountKey':
        """
