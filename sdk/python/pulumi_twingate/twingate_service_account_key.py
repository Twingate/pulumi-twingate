...
class TwingateServiceAccountKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] expiration_time: Specifies how many days until a Service Account Key expires. This should be an integer between 0 and 365 representing the number of days until the Service Account Key will expire. Defaults to 0, meaning the key will never expire.
        :param pulumi.Input[builtins.str] name: The name of the Service Key
        """
...
class _TwingateServiceAccountKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the Service Key
        :param pulumi.Input[builtins.str] service_account_id: The id of the Service Account
        :param pulumi.Input[builtins.str] token: Autogenerated Service Key token. Used to configure a Twingate Client running in headless mode.
        """
        if expiration_time is not None:
            pulumi.set(__self__, "expiration_time", expiration_time)
...
class TwingateServiceAccountKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            service_account_id: Optional[pulumi.Input[builtins.str]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None) -> 'TwingateServiceAccountKey':
        """
