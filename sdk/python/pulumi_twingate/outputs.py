...
__all__ = [
    ...
    'TwingateWebAppResourceAccessGroup',
    'TwingateWebAppResourceAccessGroupAccessPolicy',
    'TwingateWebAppResourceAccessPolicy',
    'TwingateWebAppResourceDownstream',
    'TwingateWebAppResourceUpstream',
...
@pulumi.output_type
class TwingateWebAppResourceAccessGroup(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "accessPolicies":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TwingateWebAppResourceAccessGroup. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TwingateWebAppResourceAccessGroup.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 access_policies: Optional[Sequence['outputs.TwingateWebAppResourceAccessGroupAccessPolicy']] = None,
                 group_id: Optional[_builtins.str] = None,
                 security_policy_id: Optional[_builtins.str] = None):
        """
        :param Sequence['TwingateWebAppResourceAccessGroupAccessPolicyArgs'] access_policies: Restrict access according to JIT access policy
        :param _builtins.str group_id: Group ID that will have permission to access the Resource.
        :param _builtins.str security_policy_id: The ID of a `get_twingate_security_policy` to use as the access policy for the group IDs in the access block. Default is 'Null' which points to `Default Policy` on Admin console.
        """
        if access_policies is not None:
    ...
    @_builtins.property
    @pulumi.getter(name="accessPolicies")
    def access_policies(self) -> Optional[Sequence['outputs.TwingateWebAppResourceAccessGroupAccessPolicy']]:
        """
        Restrict access according to JIT access policy
        """
        return pulumi.get(self, "access_policies")
...
@pulumi.output_type
class TwingateWebAppResourceAccessGroupAccessPolicy(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "approvalMode":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TwingateWebAppResourceAccessGroupAccessPolicy. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TwingateWebAppResourceAccessGroupAccessPolicy.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class TwingateWebAppResourceAccessPolicy(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "approvalMode":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TwingateWebAppResourceAccessPolicy. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TwingateWebAppResourceAccessPolicy.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class TwingateWebAppResourceDownstream(dict):
    def __init__(__self__, *,
                 port: _builtins.int):
        """
        :param _builtins.int port: The port number. Must be between 1 and 65535 inclusive.
        """
...
@pulumi.output_type
class TwingateWebAppResourceUpstream(dict):
    def __init__(__self__, *,
                 port: _builtins.int):
        """
        :param _builtins.int port: The port number. Must be between 1 and 65535 inclusive.
