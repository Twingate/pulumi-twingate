...
def get_twingate_service_accounts(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Returns only service accounts that exactly match this name. If no options are passed it will return all service accounts. Only one option can be used at a time.
    :param _builtins.str name_contains: Match when the value exist in the name of the service account.
    :param _builtins.str name_exclude: Match when the exact value does not exist in the name of the service account.
    :param _builtins.str name_prefix: The name of the service account must start with the value.
    :param _builtins.str name_regexp: The regular expression match of the name of the service account.
    :param _builtins.str name_suffix: The name of the service account must end with the value.
    """
    __args__ = dict()
    __args__['name'] = name
