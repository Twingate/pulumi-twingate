...
class TwingateUserArgs:
    def __init__(__self__, *,
                 ...
                 send_invite: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] is_active: Determines whether the User is active or not. Inactive users will be not able to sign in.
        :param pulumi.Input[builtins.str] last_name: The User's last name
        :param pulumi.Input[builtins.str] role: Determines the User's role. Either ADMIN, DEVOPS, SUPPORT or MEMBER.
        :param pulumi.Input[builtins.bool] send_invite: Determines whether to send an email invitation to the User. True by default.
        """
    ...
    def send_invite(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @send_invite.setter
    def send_invite(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _TwingateUserState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role: Determines the User's role. Either ADMIN, DEVOPS, SUPPORT or MEMBER.
        :param pulumi.Input[builtins.bool] send_invite: Determines whether to send an email invitation to the User. True by default.
        :param pulumi.Input[builtins.str] type: Indicates the User's type. Either MANUAL or SYNCED.
        """
...
class TwingateUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role: Optional[pulumi.Input[builtins.str]] = None,
            send_invite: Optional[pulumi.Input[builtins.bool]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'TwingateUser':
        """
    ...
    @property
    @pulumi.getter(name="sendInvite")
    def send_invite(self) -> pulumi.Output[builtins.bool]:
        """
        Determines whether to send an email invitation to the User. True by default.
        """
        return pulumi.get(self, "send_invite")
