...
def get_twingate_connectors(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Returns only connectors that exactly match this name. If no options are passed it will return all connectors. Only one option can be used at a time.
    :param builtins.str name_contains: Match when the value exist in the name of the connector.
    :param builtins.str name_exclude: Match when the exact value does not exist in the name of the connector.
    :param builtins.str name_prefix: The name of the connector must start with the value.
    :param builtins.str name_regexp: The regular expression match of the name of the connector.
    :param builtins.str name_suffix: The name of the connector must end with the value.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_twingate_connectors_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
