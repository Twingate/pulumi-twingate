...
class TwingateDNSFilteringProfileArgs:
    def __init__(__self__, *,
                 priority: pulumi.Input[builtins.float],
                 ...
                 fallback_method: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.float] priority: A floating point number representing the profile's priority.
        ...
        :param pulumi.Input[builtins.str] fallback_method: The DNS filtering profile's fallback method. One of "AUTO" or "STRICT". Defaults to "STRICT".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] groups: A set of group IDs that have this as their DNS filtering profile. Defaults to an empty set.
        :param pulumi.Input[builtins.str] name: The DNS filtering profile's name.
    ...
    @property
    @pulumi.getter
    def priority(self) -> pulumi.Input[builtins.float]:
        """
    ...
    @priority.setter
    def priority(self, value: pulumi.Input[builtins.float]):
    ...
    def fallback_method(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def fallback_method(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TwingateDNSFilteringProfile(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="fallbackMethod")
    def fallback_method(self) -> pulumi.Output[builtins.str]:
        """
        The DNS filtering profile's fallback method. One of "AUTO" or "STRICT". Defaults to "STRICT".
        """
        return pulumi.get(self, "fallback_method")
