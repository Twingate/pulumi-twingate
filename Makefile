...
VERSION         := 2.1.2-1 #$(shell pulumictl get version)
...
build_nodejs:: VERSION := 2.1.2-1 #$(shell pulumictl get version --language javascript)
...
build_python:: PYPI_VERSION := 2.1.2-1 #$(shell pulumictl get version --language python)
...
build_dotnet:: DOTNET_VERSION := 2.1.2-1 #$(shell pulumictl get version --language dotnet)
